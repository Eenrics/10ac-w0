...
class utils:
    def break_combined_weeks(self, combined_weeks):
        """
    ...
    def from_msg_get_replies(self, msg):
        replies = []
    ...
    def msgs_to_df(self, msgs):
        msg_list = self.get_messages_dict(msgs)
    ...
    def process_msgs(self, msg):
        ...
        rply_list = self.from_msg_get_replies(msg)
